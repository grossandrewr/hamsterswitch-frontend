          ...
          <>
            ...
            >
              <InfoTwoToneIcon
                style={{
                  fontSize: 40,
                  color: album["gptDescription"] ? "#FFFF99" : "grey",
                }}
              />
            </IconButton>
            <IconButton
            ...
            >
              <PlayCircleTwoToneIcon
                style={{ fontSize: 100, color: "#FFFF99" }}
              />
            </IconButton>
          </>
        )}
  ...
  return (
    <Grid container alignItems="center" justifyContent="center" height="700px">
      {isLoading ? (
        ...
        >
          <l-quantum size="120" speed="3" color="black"></l-quantum>
        ...
        <Grid
          ...
          alignItems="center"
          justifyContent="center"
          style={{ height: "630px", maxWidth: "750px" }}
        >
          {getAlbumGrid(
            albumResults,
            handlePlayAlbum,
